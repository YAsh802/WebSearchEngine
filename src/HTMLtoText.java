...
public class HTMLtoText extends HTMLEditorKit.ParserCallback {
 ...
 public static void main(String[] args) throws IOException,FileNotFoundException,NullPointerException {
	 ...
	 File directoryPth = new File("C:\\Users\\AVI\\Downloads\\W3C Web Pages\\W3C Web Pages");
	 ...
	 BufferedWriter bufferedWriterBW = new BufferedWriter(new FileWriter("C:\\Users\\AVI\\Downloads\\W3C Web Pages\\W3C Web Pages\\Text"+destinationfile.getName()+".txt"));
